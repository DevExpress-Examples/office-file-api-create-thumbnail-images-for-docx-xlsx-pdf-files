...
Namespace FilesPreviewGenerator
    Public NotInheritable Class ImageExporterHelper

        Private Sub New()
        End Sub

        Public Shared Function GenerateImageFromExcel(ByVal fileName As String) As Bitmap
        ...
        Public Shared Function GenerateImageFromPDF(ByVal fileName As String, ByVal largestEdgeLength As Integer) As Bitmap
            ...
            End Using
        End Function
        Public Shared Function GenerateImageFromWord(ByVal fileName As String) As Bitmap
            ...
            End Using
        End Function
        Private Shared Function ExportToImage(ByVal component As IPrintable) As Bitmap
